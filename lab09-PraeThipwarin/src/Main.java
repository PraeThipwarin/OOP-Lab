...
public class Main {
            ...
            while ((textLine = reader.readLine()) != null) {
                try {
                    ...
                    if (result != null) {
                        ...
                        WriteFile(results.toString(), "src/ResultsText");
                    } else {
    ...
    private static ArrayList<String> validateExpression(String expression) {
    ...
    private static String calculateExpression(ArrayList<String> listOfProposition) {
